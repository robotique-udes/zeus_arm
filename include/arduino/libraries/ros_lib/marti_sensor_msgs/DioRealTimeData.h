...
namespace marti_sensor_msgs
{
  ...
  class DioRealTimeData : public ros::Msg
  {
    ...
    DioRealTimeData():
      ...
      sample_states_length(0), sample_states(NULL),
      sample_times_length(0), sample_times(NULL)
    {
    }
    ...
    const char * getType(){ return "marti_sensor_msgs/DioRealTimeData"; };
    const char * getMD5(){ return "98eef69989f7d8b60307368e8e339ff4"; };
