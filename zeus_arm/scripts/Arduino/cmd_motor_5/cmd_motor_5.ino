...
ros::Subscriber<std_msgs::Float32> sub("/zeus_arm/joint_5_velocity_controller/command", &messageCb );
ros::Publisher state("/zeus_arm/joint_5_state", &curr_pos);
